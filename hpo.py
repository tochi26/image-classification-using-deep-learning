...
# Add this line if you don't want your job to fail unexpected after multiple hours of training
...
def test(model, test_loader, criterion):
    ...
    # Also we should divide the output by the number of trained objects, not by the numebr of groups of trained objects...
...
def train(model, train_loader, validation_loader, criterion, optimizer):
    epochs=50 # this is a hack - this script will actually break after first epoch :)
    best_loss=1e6
